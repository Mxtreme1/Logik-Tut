...
\newpage
        ...
        \item c)\\
            ...
            \end{itemize}
        \item d)\\
            $\overset{A1, Blatt6}{\Rightarrow} \text{ T vollständig } \Leftrightarrow$ je zwei Modelle von T sind elementar äquivalent.\\
            \\Seien also $\mathcal{M}_1 \vDash T, \mathcal{M}_2 \vDash T$ Modelle\\
            $\overset{b)}{\Rightarrow} \mathcal{M}_1 \preceq \mathcal{N}_1, \mathcal{M}_2 \preceq \mathcal{N}_2$\\
            $\overset{c)}{\Rightarrow} \mathcal{M}_1 \equiv \mathcal{N}_1 \equiv \mathcal{N}_2 \equiv \mathcal{M}_2$\\
